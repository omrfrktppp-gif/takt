...
```bash
./.claude/skills/seo/bin/claude-seo run --extension banana setup_mcp.py --key YOUR_KEY
```
...
```bash
./.claude/skills/seo/bin/claude-seo run --extension banana validate_setup.py
```
